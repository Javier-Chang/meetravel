        ...
        void 0 === (r = "function" == typeof (o = function() {
                ...
                class i {
                    ...
                    runTask(e, t, n) {
                        ...
                        try {
                            ...
                            e.state !== v && e.state !== Z && (e.type == P || e.data && e.data.isPeriodic ? o && e._transitionTo(T, E) : (e.runCount = 0,
            ...
            Zone.__load_patch("ZoneAwarePromise", (e,t,n)=>{
                ...
                function T(e, o, s) {
                    ...
                    if (null === e[g]) {
                        ...
                        if (!1 !== o && s instanceof D && s.hasOwnProperty(g) && s.hasOwnProperty(_) && null !== s[g])
                            w(s),
                            T(e, s[g], s[_]);
                ...
                class D {
                    ...
                    then(e, n) {
                        ...
                        const r = new o(S)
                          , s = t.current;
                        return null == this[g] ? this[_].push(s, r, e, n) : Z(this, s, r, e, n),
                        r
                    }
                    catch(e) {
                        ...
                        o[k] = k;
                        const r = t.current;
                        return null == this[g] ? this[_].push(r, o, e, e) : Z(this, r, o, e, e),
                        o
                    }
                }
                D.resolve = D.resolve,
                ...
                let O = o(e, "Promise");
                O && !O.configurable || (O && delete O.writable,
                O && delete O.value,
                O || (O = {
                    configurable: !0,
                    enumerable: !0
            ...
            function E(n, o, r) {
                ...
                s.set = function(e) {
                    let t = this;
                    t || n !== f || (t = f),
                    t && (t[h] && t.removeEventListener(l, T),
                    c && c.apply(t, d),
                    "function" == typeof e ? (t[h] = e,
                    t.addEventListener(l, T, !1)) : t[h] = null)
                }
                ,
                s.get = function() {
                    let e = this;
            ...
            function S(e) {
                ...
                for (r in o)
                    "XMLHttpRequest" === e && "responseBlob" === r || function(n) {
                        ...
                        : t(f[e].prototype, n, {
                            set: function(t) {
                                "function" == typeof t ? (this[Z][n] = c(t, e + "." + n),
                                C(this[Z][n], t)) : this[Z][n] = t
                            },
                            get: function() {
                                return this[Z][n]
                            }
            ...
            function I() {
                ...
                try {
                    const e = p.navigator.userAgent;
                    -1 === e.indexOf("MSIE ") && -1 === e.indexOf("Trident/") && -1 === e.indexOf("Edge/") || (z = !0)
                } catch (e) {}
                return z
            }
            ...
            function F(e, t, o) {
                ...
                function g(t, o) {
                    ...
                    const P = p ? function(e) {
                        if (!b.isExisting)
                            return T.call(b.target, b.eventName, b.capture ? d : f, b.options)
                    }
                    : function(e) {
                      ...
                      , O = p ? function(e) {
                        ...
                        if (e.allRemoved)
                            return E.call(e.target, e.eventName, e.capture ? d : f, e.options)
                    }
                    : function(e) {
                    ...
                    return y[r] = A(T, h, P, O, k),
                    S && (y.prependListener = A(S, ".prependListener:", (function(e) {
                        ...
                        if (u)
                            for (let e = 0; e < u.length; e++) {
                                ...
                                if (z(o, a))
                                    ...
                                    t[l] = null,
                                    "string" == typeof n) && (t[i + "ON_PROPERTY" + n] = null),
                                    o.zone.cancelTask(o),
                                    k ? t : void 0
                            }
                        return E.apply(this, arguments)
                ...
                t[o] = function(s, i, c) {
                    return i && i.prototype && r.forEach((function(t) {
                        ...
                        if (s.hasOwnProperty(t)) {
                            ...
                            e._redefineProperty(i.prototype, t, n)) : s[t] && (s[t] = e.wrapWithCurrentZone(s[t], r))
                        } else
            ...
            function se(e, t, n, o) {
                ...
                r = D(e, t += o, n=>function(r, s) {
                    if ("function" == typeof s[0]) {
                        ...
                        return "number" == typeof n ? a[n] = e : n && (n[re] = e),
                ...
                s = D(e, n, t=>function(n, o) {
                    const r = o[0];
                    let s;
                    "number" == typeof r ? s = a[r] : (s = r && r[re],
                    s || (s = r)),
                    s && "string" == typeof s.type ? "notScheduled" !== s.state && (s.cancelFn && s.data.isPeriodic || 0 === s.runCount) && ("number" == typeof r ? delete a[r] : r && (r[re] = null),
                    s.zone.cancelTask(s)) : t.apply(e, o)
                }
                )
            }
            function ae(e, t) {
                if (Zone[t.symbol("patchEventTarget")])
                    return;
                const {eventNames: n, zoneSymbolEventNames: o, TRUE_STR: r, FALSE_STR: s, ZONE_SYMBOL_PREFIX: a} = t.getGlobalObjects();
